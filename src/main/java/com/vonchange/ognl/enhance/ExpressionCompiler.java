package com.vonchange.ognl.enhance;

import com.vonchange.ognl.ASTAnd;
import com.vonchange.ognl.ASTChain;
import com.vonchange.ognl.ASTConst;
import com.vonchange.ognl.ASTCtor;
import com.vonchange.ognl.ASTList;
import com.vonchange.ognl.ASTMethod;
import com.vonchange.ognl.ASTOr;
import com.vonchange.ognl.ASTProperty;
import com.vonchange.ognl.ASTRootVarRef;
import com.vonchange.ognl.ASTStaticField;
import com.vonchange.ognl.ASTStaticMethod;
import com.vonchange.ognl.ASTThisVarRef;
import com.vonchange.ognl.ASTVarRef;
import com.vonchange.ognl.ExpressionNode;
import com.vonchange.ognl.Node;
...
/*         System.out.println("castExpression() with expression " + expression + " expr class: " + expression.getClass() + " currentType is: " + context.getCurrentType()
     ...
     * during method calls to {@link OgnlExpressionCompiler#getSuperOrInterfaceClass(Method, Class)}.
     *
     * @param m
